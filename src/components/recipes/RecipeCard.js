  ...
  if (recipe === null || recipe === undefined || recipe.length === 0) return <Spinner />
    ...
    const RenderIndgredientsMeasures = () => {
      if (recipe.strIndgredients1 === null || recipe.strMeasure1 === null) return ''
        ...
        // Slice desired arrays from the main array and clean them up from empty values 53006
    ...
    const openModal = () => {
      ...
      ele.className !== "cont_modal cont_modal_active" ? ele.className = "cont_modal cont_modal_active" : ele.className = "cont_modal"
    }
